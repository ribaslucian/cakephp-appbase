    ...
    <div class="column eight wide centered">
        ...
        <div class="ui segment basic bg white border shadow " style="padding: 20px;">
            <h5 class="ui header b smooth color">
                Solicitação de reenvio de e-mail para Confirmação de Registro.
            ...
            <div class="field">
                <label for="IssuerCnpj">
                    <i class="icon asterisk purple"></i>
                    CNPJ:
                    <div class="small text smooth color">
                        Formato de entrada: xx.xxx.xxx/xxxx-xx
                    </div>
                </label>

                <div class="input">
                    <?php echo $this->SemanticForm->input('cnpj', array('class' => 'mask cnpj', 'maxlength' => 18)); ?>
                </div>

                <?php echo $this->SemanticForm->help('cnpj'); ?>
            </div>
